...
namespace Notification.API.DAL.Migrations
{
    ...
    [Migration("20230724141011_UpdateUserInfo_1")]
            ...
            modelBuilder.Entity("Notification.API.Domain.Notice.NotificationSetting", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 7, 24, 18, 10, 11, 6, DateTimeKind.Unspecified).AddTicks(6581), new TimeSpan(0, 4, 0, 0, 0)))
            ...
            modelBuilder.Entity("Notification.API.Domain.Notice.UserNotification", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 7, 24, 18, 10, 11, 4, DateTimeKind.Unspecified).AddTicks(4226), new TimeSpan(0, 4, 0, 0, 0)))
                        .HasColumnName("_created");
