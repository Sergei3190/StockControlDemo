...
namespace StockControl.API.DAL.Migrations
{
    ...
    [Migration("20231013102025_Update_type_format_CreateTime")]
    partial class Update_type_format_CreateTime
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("StockControl.API.Domain.Stock.Moving", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 10, 13, 14, 20, 25, 375, DateTimeKind.Unspecified).AddTicks(5492), new TimeSpan(0, 4, 0, 0, 0)))
            ...
            modelBuilder.Entity("StockControl.API.Domain.Stock.Nomenclature", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 10, 13, 14, 20, 25, 369, DateTimeKind.Unspecified).AddTicks(8412), new TimeSpan(0, 4, 0, 0, 0)))
                        .HasColumnName("_created");
            ...
            modelBuilder.Entity("StockControl.API.Domain.Stock.Organization", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 10, 13, 14, 20, 25, 368, DateTimeKind.Unspecified).AddTicks(5829), new TimeSpan(0, 4, 0, 0, 0)))
                        .HasColumnName("_created");
            ...
            modelBuilder.Entity("StockControl.API.Domain.Stock.Party", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 10, 13, 14, 20, 25, 383, DateTimeKind.Unspecified).AddTicks(3416), new TimeSpan(0, 4, 0, 0, 0)))
                        .HasColumnName("_created");
            ...
            modelBuilder.Entity("StockControl.API.Domain.Stock.Receipt", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 10, 13, 14, 20, 25, 372, DateTimeKind.Unspecified).AddTicks(2700), new TimeSpan(0, 4, 0, 0, 0)))
                        .HasColumnName("_created");
            ...
            modelBuilder.Entity("StockControl.API.Domain.Stock.StockAvailability", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 10, 13, 14, 20, 25, 385, DateTimeKind.Unspecified).AddTicks(143), new TimeSpan(0, 4, 0, 0, 0)))
                        .HasColumnName("_created");
            ...
            modelBuilder.Entity("StockControl.API.Domain.Stock.Warehouse", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 10, 13, 14, 20, 25, 371, DateTimeKind.Unspecified).AddTicks(406), new TimeSpan(0, 4, 0, 0, 0)))
                        .HasColumnName("_created");
            ...
            modelBuilder.Entity("StockControl.API.Domain.Stock.WriteOff", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 10, 13, 14, 20, 25, 379, DateTimeKind.Unspecified).AddTicks(2407), new TimeSpan(0, 4, 0, 0, 0)))
                        .HasColumnName("_created");
