...
namespace StockControl.API.DAL.Migrations
{
    ...
    [Migration("20231019151123_update_parties_types")]
    partial class update_parties_types
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("StockControl.API.Domain.Stock.Moving", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 10, 19, 19, 11, 23, 533, DateTimeKind.Unspecified).AddTicks(3630), new TimeSpan(0, 4, 0, 0, 0)))
            ...
            modelBuilder.Entity("StockControl.API.Domain.Stock.Nomenclature", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 10, 19, 19, 11, 23, 527, DateTimeKind.Unspecified).AddTicks(2694), new TimeSpan(0, 4, 0, 0, 0)))
                        .HasColumnName("_created");
            ...
            modelBuilder.Entity("StockControl.API.Domain.Stock.Organization", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 10, 19, 19, 11, 23, 526, DateTimeKind.Unspecified).AddTicks(140), new TimeSpan(0, 4, 0, 0, 0)))
                        .HasColumnName("_created");
            ...
            modelBuilder.Entity("StockControl.API.Domain.Stock.Party", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 10, 19, 19, 11, 23, 541, DateTimeKind.Unspecified).AddTicks(272), new TimeSpan(0, 4, 0, 0, 0)))
                        .HasColumnName("_created");
            ...
            modelBuilder.Entity("StockControl.API.Domain.Stock.Receipt", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 10, 19, 19, 11, 23, 529, DateTimeKind.Unspecified).AddTicks(7688), new TimeSpan(0, 4, 0, 0, 0)))
                        .HasColumnName("_created");
            ...
            modelBuilder.Entity("StockControl.API.Domain.Stock.StockAvailability", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 10, 19, 19, 11, 23, 542, DateTimeKind.Unspecified).AddTicks(5876), new TimeSpan(0, 4, 0, 0, 0)))
                        .HasColumnName("_created");
            ...
            modelBuilder.Entity("StockControl.API.Domain.Stock.Warehouse", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 10, 19, 19, 11, 23, 528, DateTimeKind.Unspecified).AddTicks(4860), new TimeSpan(0, 4, 0, 0, 0)))
                        .HasColumnName("_created");
            ...
            modelBuilder.Entity("StockControl.API.Domain.Stock.WriteOff", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 10, 19, 19, 11, 23, 537, DateTimeKind.Unspecified).AddTicks(1419), new TimeSpan(0, 4, 0, 0, 0)))
                        .HasColumnName("_created");
