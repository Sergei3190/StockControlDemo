...
namespace StockControl.API.DAL.Migrations
{
    ...
    [Migration("20231013075445_Initial")]
            ...
            modelBuilder.Entity("StockControl.API.Domain.Stock.Moving", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 10, 13, 11, 54, 45, 14, DateTimeKind.Unspecified).AddTicks(5099), new TimeSpan(0, 4, 0, 0, 0)))
            ...
            modelBuilder.Entity("StockControl.API.Domain.Stock.Nomenclature", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 10, 13, 11, 54, 45, 9, DateTimeKind.Unspecified).AddTicks(1109), new TimeSpan(0, 4, 0, 0, 0)))
                        .HasColumnName("_created");
            ...
            modelBuilder.Entity("StockControl.API.Domain.Stock.Organization", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 10, 13, 11, 54, 45, 7, DateTimeKind.Unspecified).AddTicks(9651), new TimeSpan(0, 4, 0, 0, 0)))
                        .HasColumnName("_created");
            ...
            modelBuilder.Entity("StockControl.API.Domain.Stock.Party", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 10, 13, 11, 54, 45, 21, DateTimeKind.Unspecified).AddTicks(5163), new TimeSpan(0, 4, 0, 0, 0)))
                        .HasColumnName("_created");
            ...
            modelBuilder.Entity("StockControl.API.Domain.Stock.Receipt", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 10, 13, 11, 54, 45, 11, DateTimeKind.Unspecified).AddTicks(3371), new TimeSpan(0, 4, 0, 0, 0)))
                        .HasColumnName("_created");
            ...
            modelBuilder.Entity("StockControl.API.Domain.Stock.StockAvailability", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 10, 13, 11, 54, 45, 22, DateTimeKind.Unspecified).AddTicks(9886), new TimeSpan(0, 4, 0, 0, 0)))
                        .HasColumnName("_created");
            ...
            modelBuilder.Entity("StockControl.API.Domain.Stock.Warehouse", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 10, 13, 11, 54, 45, 10, DateTimeKind.Unspecified).AddTicks(2084), new TimeSpan(0, 4, 0, 0, 0)))
                        .HasColumnName("_created");
            ...
            modelBuilder.Entity("StockControl.API.Domain.Stock.WriteOff", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 10, 13, 11, 54, 45, 17, DateTimeKind.Unspecified).AddTicks(9243), new TimeSpan(0, 4, 0, 0, 0)))
                        .HasColumnName("_created");
