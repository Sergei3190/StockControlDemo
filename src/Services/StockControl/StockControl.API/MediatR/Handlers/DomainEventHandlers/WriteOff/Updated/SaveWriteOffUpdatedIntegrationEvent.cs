...
/// <summary>
/// Обработчик доменного события обновления списания
/// </summary>
public class SaveWriteOffUpdatedIntegrationEvent
	: INotificationHandler<WriteOffUpdatedDomainEvent>
{
	private readonly IWriteOffsService _service;
	private readonly IIntegrationEventService _integrationService;
	private readonly IIdentityService _identityService;

	public SaveWriteOffUpdatedIntegrationEvent(
	...
	public async Task Handle(WriteOffUpdatedDomainEvent @event, CancellationToken cancellationToken)
	{
		...
		var integrationEvent = new WriteOffUpdatedIntegrationEvent(singlData.Id, singlData.Number, userName);
