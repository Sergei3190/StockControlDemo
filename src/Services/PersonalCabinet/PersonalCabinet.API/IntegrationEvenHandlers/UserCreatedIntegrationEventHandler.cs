...
public class UserCreatedIntegrationEventHandler : IIntegrationEventHandler<UserCreatedIntegrationEvent>
{
	...
	public async Task Handle(UserCreatedIntegrationEvent @event)
	{
		...
		// создаём персону с минимальными данными на основании поступивших данных
		var person = new UserPersonDto() { LastName = userInfo!.Name, FirstName = userInfo.Name, MiddleName = userInfo.Name, UserId = userInfo.Id };
		await _mediator.Send(new CreateUserPersonCommand(person)).ConfigureAwait(false);
