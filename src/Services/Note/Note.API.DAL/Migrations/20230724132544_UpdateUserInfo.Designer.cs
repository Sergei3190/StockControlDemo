...
namespace Note.API.DAL.Migrations
{
    ...
    [Migration("20230724132544_UpdateUserInfo")]
            ...
            modelBuilder.Entity("Note.API.Domain.Note.UserNote", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 7, 24, 17, 25, 44, 793, DateTimeKind.Unspecified).AddTicks(3267), new TimeSpan(0, 4, 0, 0, 0)))
            ...
            modelBuilder.Entity("Service.Common.Entities.App.UserInfo", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 7, 24, 17, 25, 44, 792, DateTimeKind.Unspecified).AddTicks(9511), new TimeSpan(0, 4, 0, 0, 0)))
                        .HasColumnName("_created");
