...
export class OrganizationItemComponent extends SideDrawerBaseComponent<OrganizationItemComponent> implements OnInit {

  title: string;
  model: IOrganizationItem;
  form: FormGroup;
  update: (model: IOrganizationItem) => Observable<IOrganizationItem | undefined>;
