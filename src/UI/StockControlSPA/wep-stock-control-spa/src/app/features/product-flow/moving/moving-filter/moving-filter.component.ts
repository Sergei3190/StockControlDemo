...
@Component({
  selector: 'app-moving-filter',
  templateUrl: './moving-filter.component.html',
  styleUrls: ['./moving-filter.component.scss']
})
export class MovingFilterComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<MovingFilterComponent>,
